...
namespace AustinsFirstProject.Library_Git.Helpers
{
    public static class Constants
    {
        ...
        public static Credentials CreateUsernamePasswordCredentials(string user, string pass, bool secure)
        {
            if (secure)
            {
        ...
        /*public static bool IsRunningOnUnix
        {
            get
            {
                return Platform.OperatingSystem == LibGit2Sharp.Core.OperatingSystemType.MacOSX ||
